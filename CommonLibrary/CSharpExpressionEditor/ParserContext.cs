// <copyright file=ParserContext company=E2E Robotics>
...
{
    public class ParserContext : LocationReferenceEnvironment, IValueSerializerContext, IXamlNameResolver, INamespacePrefixLookup, IXamlNamespaceResolver
    {
