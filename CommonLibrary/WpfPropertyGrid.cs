// <copyright file=WpfPropertyGrid company=E2E BOTS>
...
namespace CommonLibrary
{
    ...
    public class WpfPropertyGrid : Grid
    {
        ...
        public WpfPropertyGrid()
        {
            ...
            var methods = inspectorType.GetMethods(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance |
                 System.Reflection.BindingFlags.DeclaredOnly);
            ...
            this.PropertyToolBar = inspectorType.GetMethod("get_PropertyToolBar",
                 System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance |
                 System.Reflection.BindingFlags.DeclaredOnly).Invoke(inspector, new object[0]) as Control;
        ...
        private void GotFocusHandler(object sender, RoutedEventArgs args)
        {
            ...
            if (theSelectedObjects != null && theSelectedObjects.Length > 0)
            {
                ...
                if (data is System.Activities.Presentation.Expressions.TextualExpressionEditor)
                {
                    System.Activities.Presentation.Expressions.TextualExpressionEditor tde = (System.Activities.Presentation.Expressions.TextualExpressionEditor)data;
                    DesignerView designerView = this.Designer.Context.Services.GetService<DesignerView>();
                    args.Handled = true;
                    return;
                }
                else
