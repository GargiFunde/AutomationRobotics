    ...
    //   HTMLDocument htmlDoc = null;
        ...
        private Web()
        {
            try
            {
                ...
                //}
                //iOpenFile = 0;
              //  SelectHelper.LaunchScraping -= LaunchScraping;  doubt
              //  SelectHelper.LaunchScraping += LaunchScraping;   doubt
        ...
        private void AddHandlersXPath()
        {
            try
            {
                ...
                m_GlobalHook.MouseDoubleClick -= M_GlobalHook_MouseDoubleClickXPath;
                m_GlobalHook.MouseDoubleClick += M_GlobalHook_MouseDoubleClickXPath;
        ...
        private bool EmulatedXPath(IWebElement evtObj)
        {
            ...
            try
            {
                ...
                MainWindow.Webwin.Rtxt_Xpath.Document.Blocks.Clear();
               MainWindow.Webwin.Rtxt_Xpath.AppendText(currxpath);
