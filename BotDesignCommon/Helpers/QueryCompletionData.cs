// <copyright file=QueryCompletionData company=E2E BOTS>
...
namespace BotDesignCommon.Helpers
{
    public class QueryCompletionData : ICompletionData
    {
        ...
        {
            return BitmapFrame.Create(typeof(QueryCompletionData).Assembly.GetManifestResourceStream("BOTDesigner.Resources.ExpressionEditor." + resourceName));
        }
