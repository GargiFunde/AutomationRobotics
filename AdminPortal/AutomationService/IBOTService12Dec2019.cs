...
namespace AutomationService
{
    ...
    public interface IBOTService
    {
        ...
        [OperationContract]
        DataTable GetPageAccess(int groupid, int tenantid, string username, string pagename);
        [OperationContract]
        ...
        [OperationContract]
        DataTable GetLogsForDashboardBots(String strbotid, string strmachinename, int groupid, int tenantid);
