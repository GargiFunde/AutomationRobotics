<%@ page title="" language="C#" masterpagefile="~/ControlTower/MasterPageSkin.master" autoeventwireup="true" inherits="DemoMasterPage2_AddGroup, App_Web_bmrj5qz2" %>
            ...
            <ContentTemplate>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h2 class="m-0 font-weight-bold poptxt">ADD GROUP
                        </h2>   
                    </div>
                    <div class="card-body TableHeaderFont">
                        <div>
                            <div class="form-group">
                                <asp:Label ID="Label3" runat="server" class=" font-weight-normal poptxt"><b>Group Name<span class="text-danger">*&nbsp;&nbsp;</span></b></asp:Label>
                                <asp:TextBox ID="txtGroup" class="form-control input-sm animated--grow-in" runat="server"></asp:TextBox>
                            </div>

                            <div class="form-group" align="center">
                                <asp:Button ID="btnSaveGroup" runat="server" class="btn btn-primary colorSidebar" Text="Save" OnClick="BtnSaveGroup" Width="49%" />
                                <asp:Button ID="btnCancelGroup" runat="server" class="btn btn-danger" Text="Cancel" OnClick="BtnCancelGroup" Width="49%" />
                            </div>
                            <br />
                        </div>
                    </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h2 class="m-0 font-weight-bold poptxt">GROUPS
