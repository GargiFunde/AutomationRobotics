<%@ page title="" language="C#" masterpagefile="~/ControlTower/MasterPageSkin.master" autoeventwireup="true" inherits="ControlTower_AssetManagement1, App_Web_yn0cbmo4" %>
                ...
                <ContentTemplate>
                    <div id="DIVAddUsers" class="card shadow"  runat="server">
                        <div class="card-header py-3">
                            <h2 class="m-0 font-weight-bold poptxt">ADD ASSET
                            </h2>
                        </div>
                            ...
                            <div>
                                <div class="panel panel-default colorFont TableHeaderFont">
                                     ...
                                     <div class="form-group">
                                        <asp:Label ID="lblAssetName" class=" font-weight-bold poptxt" runat="server">Asset Name<span class="text-danger">*</span></asp:Label>
                                        <asp:TextBox ID="txtAssetName" class="form-control input-sm" runat="server" placeholder="Asset Name"></asp:TextBox>
                                    </div>

                               

                                    <div class="form-group">
                                        <asp:Label ID="lblAssetValue" class=" font-weight-bold poptxt" runat="server">Asset Value<span class="text-danger">*</span></asp:Label>
                                        <asp:TextBox ID="txtAssetValue" class="form-control input-sm" runat="server"  placeholder="Enter Asset Value"></asp:TextBox>
                                    </div>
                                    </td>
             ...
             <asp:UpdatePanel runat="server">
                  <ContentTemplate>
                      <div class="card shadow mb-4">
                          <div class="card-header py-3">
                              <h2 class="m-0 font-weight-bold poptxt">ASSETS
                                              ...
                                              <table class="table table-striped table-bordered table-hover table-responsive-lg" id="dataTables-users" width="100%">
                                                  <thead class="colorSidebar" align="center">
                                                      <tr class="TableHeaderFont">
                                                          <th scope="col" class=" font-weight-bold poptxt">Asset Name
                                                          </th>
                                                          <th scope="col" class=" font-weight-bold poptxt">Asset Value
                                                          </th>
                                          ...
                                          <div class="modal-dialog modal-lg" role="document">
                                              <div class="modal-content ">
                                                  <div class="modal-header">
                                                      <h5 class="modal-title h5 font-weight-bold text-danger" id="exampleModalLabel1">Delete Asset</h5>
