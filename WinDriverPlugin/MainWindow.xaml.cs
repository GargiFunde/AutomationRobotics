...
namespace Bot.Activity.WinDriverPlugin
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnRecord_Click(object sender, RoutedEventArgs e)
        {
           ...
           //     AppInsights.LogEvent("Record");
            ...
            else
            {
                ...
                btnRecord.Content = "Indicate Element";
        ...
        //public void SetTextWithXPath(string xpath)
        //{
        //    rtbXPath.AppendText(xpath);
        //}
        private void BtnClear_Checked(object sender, RoutedEventArgs e)
        {
        ...
        rtbXPath.Document.ContentStart,
        // TextPointer to the end of content in the RichTextBox.
        rtbXPath.Document.ContentEnd
    );
