...
{
    [ToolboxBitmap("Resources/WinDriverAddTableRows.png")]
    [Designer(typeof(WinDriver_AddTableRows_ActivityDesigner))]
    public class WinDriver_AddTableRows : BaseNativeActivity
    {
        [RequiredArgument]
        ...
        protected override void Execute(NativeActivityContext context)
        {
            ...
            DataTable dt = Table.Get(context);
