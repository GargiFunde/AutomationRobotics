    ...
    public partial class AutomationElementTreeControl : UserControl
    {
        ...
        private void InitializeTreeWalker()
        {
            ...
            if (this._treeWalker == null)
            {
                ...
                System.Windows.Automation.Condition condition1 = new PropertyCondition(AutomationElement.ProcessIdProperty, Process.GetCurrentProcess().Id);
                System.Windows.Automation.Condition condition2 = new System.Windows.Automation.AndCondition(new System.Windows.Automation.Condition[] { System.Windows.Automation.Automation.ControlViewCondition, new NotCondition(condition1) });
...
//                _elementsTreeView.Nodes[0].Expand();
        ...
        private AutomationElementTreeNode BuildNodeTreePath(AutomationElementTreeNode rootNode, Stack<AutomationElement> path)
        {
            try
            {
                ...
                return currentNode;
            } catch { /* it does not matter  -Ajit*/} return null;
        }
