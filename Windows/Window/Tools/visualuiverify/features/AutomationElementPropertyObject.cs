    ...
    class AutomationElementPropertyObject
    {
        ...
        public class GridPatternPropertyObject
        {
            ...
            public object GetItem
            {
                ...
                set { System.Windows.MessageBox.Show(_pattern.GetItem(_getItemArgs.Column, _getItemArgs.Row).Current.Name); }
            }
        }
        ...
        public class MultipleViewPatternPropertyObject
        {
            ...
            public int GetViewName
            {
                ...
                set { System.Windows.MessageBox.Show(this._pattern.GetViewName(value), constMessageCaption); }
            }
        }
        ...
        public class TablePatternPropertyObject
        {
            ...
            {
                get { return _getItemArgs; }
                set { System.Windows.MessageBox.Show(_pattern.GetItem(_getItemArgs.X, _getItemArgs.Y).Current.Name); }
            }
        }
