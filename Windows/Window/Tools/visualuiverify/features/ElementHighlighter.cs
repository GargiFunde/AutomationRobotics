...
namespace VisualUIAVerify.Features
{
    ...
    /// </summary>
    public static class ElementHighlighterFactory
    {
    ...
    public abstract class ElementHighlighter: IDisposable
    {
        ...
        public AutomationElementTreeControl _treeControl;
        ...
        private void OnSelectedNodeChanged()
        {
            try
            {
                ...
                AutomationElementTreeNode selectedNode = null;
                //TODO: check that window is not minimized
                    ...
                    try
                    {
                        ...
                        _treeControl.Invoke(new MethodInvoker(() => { selectedNode = _treeControl.SelectedNode; }));

                        //  selectedNode = _treeControl.SelectedNode;
                        if (selectedNode != null)
                        {
                        //// ""pane" "Desktop 1" ""\"window" "Calculator ‎- Calculator" ""\"window" "Calculator" ""\"group" "" "UnitConverterRootGrid"\"group" "Number pad" "numberPad"\"button" "Six" "num6Button""
                        // if(selectedNode.TreeNode.FullPath.Contains("window"))
                        // {
                        //     string strstart =   selectedNode.TreeNode.FullPath.Substring(selectedNode.TreeNode.FullPath.IndexOf("window") + 9);


                        //     SelectHelper.ScrapingWindowTitle = strstart.Substring(0, strstart.IndexOf("\""));

                        // }
                        //// SelectHelper.ScrapingWindowTitle = selectedNode.TreeNode.FullPath;
                        //   selectedElement = selectedNode.AutomationElement;
                        //  SelectHelper.CurrentScrapControl = selectedElement;

                        SelectHelper.CurrentScrapControl = selectedNode;
                        //highlight the element
                        //SetHighlightingElement(selectedElement);
                        SetHighlightingElement(selectedNode.AutomationElement);
                    }
                    }
                    catch (Exception ex)
                    {
        ...
        //public void WindowsScrapControl(AutomationElement selectedElement)
        //{
        //    try
        //    {
        //        SelectHelper.CurrentScrapControl = selectedElement;
    ...
    class BoundingRectangleElementHighLighter : ElementHighlighter
    {
        ...
        {
            _rectangle.Color = (System.Windows.Media.Color)System.Windows.Media.ColorConverter.ConvertFromString("Red");
    ...
    class RaysAndBoundingRectangleElementHighlighter : BoundingRectangleElementHighLighter
    {
        ...
        public RaysAndBoundingRectangleElementHighlighter(AutomationElementTreeControl treeControl) : base(treeControl)
        {
            ...
            {
                ray.Color = (System.Windows.Media.Color)System.Windows.Media.ColorConverter.ConvertFromString("Blue");
