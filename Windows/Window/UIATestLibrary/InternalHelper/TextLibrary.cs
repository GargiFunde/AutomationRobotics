...
//******************************************************************* 
//* Purpose: Library of utilities used by TextPattern for UIA Verify
...
namespace InternalHelper
{
    ...
    /// ------------------------------------------------------------------------------------------
    /// <summary>Utilities used by TextPattern testing both within UIA Verify and without</summary>
    /// ------------------------------------------------------------------------------------------
    public static class TextLibrary 
    {
        ...
        public static bool IsMultiLine(AutomationElement element)
        {
            switch (typeOfProvider)
            {
                ...
                case "wpf": // TODO: Fix this post Vista
        ...
        public static void SendTwoKeys(System.Windows.Input.Key key1, System.Windows.Input.Key key2, string msg, int sleepTime)
        {
            ...
            UIVerifyLogger.LogComment(msg + "Sending keys " + key1.ToString() + ", " + key2.ToString());
