...
namespace InternalHelper.Tests
{
    ...
    public class ControlObject : TestObject
    {
        ...
        /// </summary>
        /// ---------------------------------------------------------------
        [TestCaseAttribute("TestControlView",   
            Priority = TestPriorities.Pri2,
            TestCaseType = TestCaseType.Generic,
            Status = TestStatus.Works,  
            Author = "Microsoft Corp.",
            Description = new string[] {
                "Test the control's Control View", 
            })]
        ...
        /// </summary>
        /// ---------------------------------------------------------------
        [TestCaseAttribute("TestContentView",   
            Priority = TestPriorities.Pri2,
            TestCaseType = TestCaseType.Generic,
           Status = TestStatus.Works,  
            Author = "Microsoft Corp.",
            Description = new string[] {
                "Test the control's Content View", 
            })]
        ...
        /// </summary>
        /// ---------------------------------------------------------------
        [TestCaseAttribute("TestControlProperties",    
            Priority = TestPriorities.Pri2,
            TestCaseType = TestCaseType.Generic,
            Status = TestStatus.Works,  
            Author = "Microsoft Corp.",
        ...
        /// </summary>
        /// ---------------------------------------------------------------
        [TestCaseAttribute("TestControlPatterns",  
            Priority = TestPriorities.Pri2,
            TestCaseType = TestCaseType.Generic,
           Status = TestStatus.Works,  
            Author = "Microsoft Corp.",
        ...
        internal void TS_TestControlPatterns()
        {
            ...
            foreach (XmlNode n in GetNodes(XMLPATTERNS, ctType, DEFAULT_FRAMEWORK))
            {
                ...
                if (patterns.Length > 0)
                {
                    ...
                    {
#if NATIVE_UIA
                        temp = Automation.PatternName(ap);
#else
                ...
                if (controlType != null)
                {
                    ...
                    {// {num}[{num}]   
                        ...
                        {   // BAD
                            ...
                            _errorBuffer += "ERROR_" + ++_itemCount + ":  " + element.Current.ControlType.LocalizedControlType + " should have had " + buffer + " control(s) with ControlType = " + Helpers.GetProgrammaticName(controlType) + ", but had " + aec.Count + ".  ";
                            //pass = false;
                        }
                    }
                    if (aec.Count > 0)
                ...
                case XMLPROPERTIES:
                    {
                        if (_propertiesDoc == null)
                        {
                            ...
                            _propertiesDoc.LoadXml(InternalHelper.UIVResources.FootPrint_Properties);
                        }
                        doc = _propertiesDoc;
                        break;
                    }
                ...
                case XMLPATTERNS:
                    {
                        if (_patternsDoc == null)
                        {
                            ...
                            _patternsDoc.LoadXml(InternalHelper.UIVResources.Footprint_Patterns);
                        }
                        doc = _patternsDoc;
                        break;
                    }
                ...
                case XMLCONTROLVIEW:
                    {
                        if (_controlViewDoc == null)
                        {
                            ...
                            _controlViewDoc.LoadXml(InternalHelper.UIVResources.FootPrint_ControlView);
                        }
                        doc = _controlViewDoc;
                        break;
                    }
                ...
                case XMLCONTENTVIEW:
                    {
                        if (_contentViewDoc == null)
                        {
                            ...
                            _contentViewDoc.LoadXml(InternalHelper.UIVResources.FootPrint_ContentView);
                        }
                        doc = _contentViewDoc;
                        break;
                    }
