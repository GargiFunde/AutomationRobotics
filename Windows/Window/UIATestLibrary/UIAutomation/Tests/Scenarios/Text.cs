...
namespace Microsoft.Test.UIAutomation.Tests.Scenarios
{
    ...
    public class TextScenarioTests : ScenarioObject, IDisposable
    {
        ...
        /// In theory this should be exercised by the regular UIA Verify 
