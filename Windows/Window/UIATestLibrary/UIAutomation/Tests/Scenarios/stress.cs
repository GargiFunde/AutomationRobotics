...
namespace Microsoft.Test.UIAutomation.Tests.Scenarios
{
    ...
    internal class StressTests
    {
        ...
        /// <summary></summary>
        /// -------------------------------------------------------------------
        public const string TestSuite = "Microsoft.Test.UIAutomation.Tests.Scenarios" + "." + THIS;
        ...
        /// <summary></summary>
        /// -------------------------------------------------------------------
        [StressBuckets("AutomationElement", "FocusedElement", TestLab.PullData, TestWorks.NoWorking, 1450752)]
        ...
        static string[] badInvokes = new string[] { "close" };
        ...
        public static void InvokePatternInvoke(AutomationElement element)
        {
            ...
            if (GetPatternObject(element, InvokePattern.Pattern, ref patternObj))
            {
                ...
                try
                {
                    if (Array.IndexOf(badInvokes, element.Current.Name.ToLower()) == -1)
                    {
                        pattern.Invoke();
                    }
                }
        ...
        public static void TransformPatternMove(AutomationElement element)
        {
            ...
            if (GetPatternObject(element, TransformPattern.Pattern, ref patternObj))
            {
                ...
                try
                {
                    pattern.Move(_rnd.Next(-2000, 2000), _rnd.Next(-2000, 2000));
                }
                catch (Exception exception)
                {
                    VerifyException(element, exception, 
        ...
        public static void TransformPatternResize(AutomationElement element)
        {
            ...
            if (GetPatternObject(element, TransformPattern.Pattern, ref patternObj))
            {
                ...
                try
                {
                    pattern.Resize(_rnd.Next(-10, 2000), _rnd.Next(-10, 2000));
                }
                catch (Exception exception)
                {
                    VerifyException(element, exception,
        ...
        public static void TransformPatternRotate(AutomationElement element)
        {
            ...
            if (GetPatternObject(element, TransformPattern.Pattern, ref patternObj))
            {
                ...
                try
                {
                    pattern.Rotate(_rnd.Next(-720, 720));
                }
                catch (Exception exception)
                {
                    VerifyException(element, exception,
        ...
        public static void TextPatternRangeFromPointRandom(AutomationElement element)
        {
            ...
            if (GetPatternObject(element, TextPattern.Pattern, ref patternObj))
            {
                ...
                try
                {
                    object property = pattern.RangeFromPoint(new Point(_rnd.Next(-2000, 2000), _rnd.Next(-2000, 2000)));
                }
                catch (Exception exception)
                {
                    VerifyException(element, exception,
