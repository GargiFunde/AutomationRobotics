...
namespace Microsoft.Test.UIAutomation.Tests.Scenarios
{
    ...
    public class ScreenReaderScenarioTests : ScenarioObject
    {
        ...
        string _NARRATOR_RESOURCE_DLL = "Narrator.resources.dll"; //TODO$: During Win8, Narrator.resources.dll will be going away.
        ...
        /// -------------------------------------------------------------------
        static AutomationElement _waitElement = null;
        ...
        internal void HeaderComment(TestCaseAttribute testCaseAttribute, bool initRegistry)
        {
            ...
            // bypass if this thread isn't english
            if (Thread.CurrentThread.CurrentCulture.TwoLetterISOLanguageName != "en")
                ThrowMe(CheckType.IncorrectElementConfiguration, "Only English is currently supported for Narrator UI tests");
        ...
        public void Test484002(TestCaseAttribute testCaseAttribute)
        {
            // Dump information
            HeaderComment(testCaseAttribute, false);
        ...
        public void Test487240(TestCaseAttribute testCaseAttribute)
        {
            // Dump information
            HeaderComment(testCaseAttribute);
        ...
        public void Test483995(TestCaseAttribute testCaseAttribute)
        {
            // Dump information
            HeaderComment(testCaseAttribute);
        ...
        public void Test487241(TestCaseAttribute testCaseAttribute)
        {
            // Dump information
            HeaderComment(testCaseAttribute);
        ...
        public void Test285124(TestCaseAttribute testCaseAttribute)
        {
            // Dump information
            HeaderComment(testCaseAttribute);
        ...
        public void Test285125(TestCaseAttribute testCaseAttribute)
        {
            // Dump information
            HeaderComment(testCaseAttribute);
        ...
        public void Test285127(TestCaseAttribute testCaseAttribute)
        {
            // Dump information
            HeaderComment(testCaseAttribute);
        ...
        public void Test490652(TestCaseAttribute testCaseAttribute)
        {
        ...
        public void Test490655(TestCaseAttribute testCaseAttribute)
        {
        ...
        public void Test490654(TestCaseAttribute testCaseAttribute)
        {
        ...
        public void Test490656(TestCaseAttribute testCaseAttribute)
        {
        ...
        public void Test529778(TestCaseAttribute testCaseAttribute)
        {
        ...
        public void Test529777(TestCaseAttribute testCaseAttribute)
        {
        ...
        {
            HelperPressButton(MainForm.ButtonVoiceSettings, ActionMethod.MouseClick, CheckType.Verification);
            ...
            if (keyname == KEYNAME_BACKGROUNDMESSAGETIMEOUT)
            {
                ...
                switch (regvalue)
                {
                    ...
                    case "60000":
                        ...
                        break;
                    case "300000":
                        // TODO$: Due to localization concerns, this is not checked correctly.
                        // This is a duplicate entry. Assume if everything else is correct,
                        // this will also be correct. We randomly set this so should
        ...
        bool WaitForMenuClosed()
        {
            try
            {
                return (_waitElement.Current.BoundingRectangle == Rect.Empty);
            }
            catch (ElementNotAvailableException)
            {
                return true;
        ...
        bool WaitForMenuCollapsed()
        {
            try
            {
                ExpandCollapsePattern ecp = _waitElement.GetCurrentPattern(ExpandCollapsePattern.Pattern) as ExpandCollapsePattern;
        ...
        {
            return (ExpandCollapseState.Expanded == (ExpandCollapseState)_waitElement.GetCurrentPropertyValue(ExpandCollapsePattern.ExpandCollapseStateProperty));
        }
    ...
    class MainForm
    {
        ...
        public static AutomationElement AutomationElement
        {
            get
            {
                String narratorWindowName = "Microsoft Narrator";  //TODO$: Globalize this resource.
                AutomationElement element = GetElementByName(AutomationElement.RootElement, TreeScope.Children, ControlType.Window, narratorWindowName);
        ...
        // --------------------------------------------------------------------
        public static AutomationElement PanelSettings { get { return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.Custom, "701"); } }  //Win7: settingsPanel
        //// --------------------------------------------------------------------
        //// Control         : Text
        ...
        // --------------------------------------------------------------------
        public static AutomationElement CheckBoxKeyboardEcho { get { return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.CheckBox, "702"); } } //Win7: KeyboardEchoCheckBox
        // --------------------------------------------------------------------
        // Control         : CheckBox
        ...
        // Parent Control  : Group
        // --------------------------------------------------------------------
        public static AutomationElement CheckBoxAnnounceSystemMessages { get { return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.CheckBox, "703"); } }  //Win7: AnnounceSystemMessagesCheckBox
        // --------------------------------------------------------------------
        // Control         : CheckBox
        ...
        // Parent Control  : Group
        // --------------------------------------------------------------------
        public static AutomationElement CheckBoxAnnounceScrollNotifications { get { return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.CheckBox, "704"); } }  //Win7: AnnounceScrollNotificationsCheckBox
        // --------------------------------------------------------------------
        // Control         : CheckBox
        ...
        // Parent Control  : Group
        // --------------------------------------------------------------------
        public static AutomationElement CheckBoxStartMinimized { get { return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.CheckBox, "705"); } }  //Win7: startMinimizedCheckBox
        //// --------------------------------------------------------------------
        //// Control         : Pane
        //// Name            :
        //// Parent          : Microsoft Narrator
        ...
        // Parent Control  : Pane
        // --------------------------------------------------------------------
        public static AutomationElement ButtonQuickHelp { get { return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.Button, "707"); } }  //Win7: QuickHelpButton
        // --------------------------------------------------------------------
        // Control         : Button
        // Name            : Voice Settings
        // Parent          :
        // Parent Control  : Pane
        // --------------------------------------------------------------------
        public static AutomationElement ButtonVoiceSettings { get { return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.Button, "708"); } }  //Win7: voiceSettingsButton
        // --------------------------------------------------------------------
        // Control         : Button
        // Name            : Exit
        // Parent          :
        // Parent Control  : Pane
        // --------------------------------------------------------------------
        public static AutomationElement ButtonExit { get { return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.Button, "709"); } } //Win7: ExitButton
        public class TitleBar
        {
            ...
            public class SystemMenuBar
            {
                ...
                // ------------------------------------------------------------
                public static AutomationElement AutomationElement { get { return GetElement(MainForm.TitleBar.AutomationElement, TreeScope.Subtree, ControlType.MenuBar, "SystemMenuBar"); } }  //Win7: ControlType.MenuBar, NarratorMainForm
                // ------------------------------------------------------------
                // Control         : Menu Item
                // Name            : System 
        ...
        {
            public static AutomationElement AutomationElement { get { return GetElement(MainForm.AutomationElement, TreeScope.Children, ControlType.MenuBar, "MenuBar"); } } //Win7: NarratorMainForm
            // ----------------------------------------------------------------
            // Control         : MenuItem
            // Name            : File
            // Parent          : Application
            ...
            {
                public static AutomationElement AutomationElement { get { return GetElement(ApplicationMenuBar.AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 1"); } }  //Win7: Item 1
                // ------------------------------------------------------------
                // Control         : MenuItem
                // Name            : Exit
                // Parent          : FileMenu
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement Exit { get { return GetElement(AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 601"); } }  //Win7: Item 257
            }
            // ----------------------------------------------------------------
            // Control         : MenuItem
            // Name            : Preferences
            ...
            public static class PreferencesMenu
            {
                ...
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement VoiceSettings { get { return GetElement(AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 602"); } }  //Win7: Item 259
                // ------------------------------------------------------------
                // Control         : MenuItem
                ...
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement EchoUsersKeystrokes { get { return GetElement(AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 603"); } } //Win7: Item 260
                // ------------------------------------------------------------
                // Control         : MenuItem
                ...
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement BackgroundMessageSettings { get { return GetElement(AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 604"); } }  //Win7: Item 261
                // ------------------------------------------------------------
                // Control         : MenuItem
                ...
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement ElementAutoMonitor { get { return GetElement(AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 605"); } }  //Win7: Item 262
                // ------------------------------------------------------------
                // Control         : MenuItem
                ...
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement AnnounceSystemMessages { get { return GetElement(AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 606"); } }  //Win7: Item 263
                // ------------------------------------------------------------
                // Control         : MenuItem
                ...
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement AnnounceScrollMessages { get { return GetElement(AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 607"); } } //Win7: Item 264
                // ------------------------------------------------------------
                // Control         : MenuItem
                // Name            : Start Narrator Minimized
                // Parent          : PreferencesMenu
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement StartNarratorMinimized { get { return GetElement(AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 608"); } }  //Win7: Item 265
            }
            // ----------------------------------------------------------------
            // Control         : MenuItem
            // Name            : Help
            ...
            public static class HelpMenu
            {
                ...
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement Documentation { get { return GetElement(HelpMenu.AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 609"); } }  //Win7: Item 267
                // ------------------------------------------------------------
                // Control         : MenuItem
                // Name            : About
                // Parent          : HelpMenu
                // Parent Control  : MenuBar
                // ------------------------------------------------------------
                public static AutomationElement HelpAbout { get { return GetElement(HelpMenu.AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 610"); } }  //Win7: Item 269
            }
        }
        public class DialogExit
        {
            ...
            { 
                get 
                {
                    String exitNarratorDialogName = "Exit Narrator"; //TODO$: Globalize this resource.
                    return GetElementByName(MainForm.AutomationElement, TreeScope.Subtree, ControlType.Window, exitNarratorDialogName);
                    //Win7: return GetElement(MainForm.AutomationElement, TreeScope.Subtree, ControlType.Window, "NarratorExitForm"); 
                } 
            }
            // ----------------------------------------------------------------
            // Control         : Pane
            ...
            // Parent Control  : Window
            // ----------------------------------------------------------------
            public static AutomationElement TableLayoutPanel 
            { 
                get
                {
                    String exitNarratorDialogText = "Are you sure you want to exit Narrator?"; //TODO$: Globalize this resource.
                    return GetElementByName(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.Pane, exitNarratorDialogText);
                    //return GetElement(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.Pane, "tableLayoutPanel");  //Win7: tableLayoutPanel NOTE: There is no direct analogue for Win8
                } 
            } 
            // ----------------------------------------------------------------
            // Control         : Pane
            ...
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement PanelButtonLayout 
            {
                get
                {
                    String exitNarratorDialogName = "Exit Narrator"; //TODO$: Globalize this resource.
                    return GetElementByName(MainForm.AutomationElement, TreeScope.Subtree, ControlType.Pane, exitNarratorDialogName);
                }
                //get { return GetElement(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.Pane, "buttonLayoutPanel"); /*Win7: buttonLayoutPanel NOTE: There is no direct analogue for Win8*/ } 
            }  
            // ----------------------------------------------------------------
            // Control         : Button
            // Name            : Yes
            ...
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement ButtonYes { get { return GetElement(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.Button, "1"); } }  //Win7: btnYes
            // ----------------------------------------------------------------
            // Control         : Button
            // Name            : No
            // Parent          :
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement ButtonNo { get { return GetElement(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.Button, "2"); } }  //Win7: btnNo
            // ----------------------------------------------------------------
            // Control         : Text
            ...
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement TextMessage 
            {
                get
                {
                    String exitNarratorDialogText = "Are you sure you want to exit Narrator?";  //TODO$: Globalize this resource.
                    return GetElementByName(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.Text, exitNarratorDialogText);
                }
                //get { return GetElement(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.Text, "lblMessage"); } 
            }
            // ----------------------------------------------------------------
            // Control         : TitleBar
            // Name            : Exit Narrator
            ...
            // Parent Control  : TitleBar
            // ----------------------------------------------------------------
            public static AutomationElement SystemMenuBar { get { return GetElement(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.MenuBar, "SystemMenuBar"); } } //Win7: NarratorExitForm
            // ----------------------------------------------------------------
            // Control         : MenuItem
            // Name            : System
            // Parent          : System Menu Bar
            // Parent Control  : MenuBar
            // ----------------------------------------------------------------
            public static AutomationElement SystemMenuItem 
            {
                get
                {
                    String systemMenuItemName = "System";  //TODO$: Globalize this resource.
                    return GetElementByName(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.MenuItem, systemMenuItemName);
                }
                //get { return GetElement(DialogExit.AutomationElement, TreeScope.Subtree, ControlType.MenuItem, "Item 1"); } 
            }
            // ----------------------------------------------------------------
            // Control         : Button
            // Name            : Close
        ...
        public class DialogVoiceSettings
        {
            ...
            public static AutomationElement AutomationElement 
            {
                get
                {
                    String voiceSettingsDialogName = "Voice Settings - Narrator"; //TODO$: Globalize this resource
                    return GetElementByName(MainForm.AutomationElement, TreeScope.Children, ControlType.Window, voiceSettingsDialogName);
                }
                //get { return GetElement(MainForm.AutomationElement, TreeScope.Children, ControlType.Window, "VoiceSettingsForm"); } 
            }
            // ----------------------------------------------------------------
            // Control         : Text
            // Name            : Select Voice
            ...
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement LabelSelectVoice 
            {
                get
                {
                    String selectVoiceTextName = "Select Voice";  //TODO$: Globalize this resource.
                    return GetElementByName(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Text, selectVoiceTextName);
                }
                //get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Text, "selectVoiceLabel"); } 
            }
            // ----------------------------------------------------------------
            // Control         : List
            // Name            : Select Voice
            ...
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement ListVoiceSettingList { get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.List, "801"); } }  //Win7: voiceSettingList
            // ----------------------------------------------------------------
            // Control         : Text
            // Name            : Set Speed
            // Parent          :
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement LabelSetSpeed 
            {
                get
                {
                    String selectSpeedTextName = "Select Speed:"; //TODO$: Globalize this resource.
                    return GetElementByName(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Text, selectSpeedTextName);
                }
                //get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Text, "setSpeedLabel"); } 
            }
            // ----------------------------------------------------------------
            // Control         : ComboBox
            // Name            : Set Speed
            ...
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement ComboBoxSpeedSetting { get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.ComboBox, "802"); } }  //Win7: speedSetting
            // ----------------------------------------------------------------
            // Control         : Text
            // Name            : Set Volume
            // Parent          :
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement LabelSetVolume 
            {
                get
                {
                    String selectVolumeLabelName = "Select Volume:"; //TODO$: Globalize this resource.
                    return GetElementByName(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Text, selectVolumeLabelName);
                }
                //get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Text, "setVolumeLabel"); } 
            }
            // ----------------------------------------------------------------
            // Control         : ComboBox
            // Name            : Set Volume
            ...
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement ComboBoxVolumeSetting { get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.ComboBox, "803"); } }  //Win7: volumeSetting
            // ----------------------------------------------------------------
            // Control         : Text
            // Name            : Set Pitch
            // Parent          :
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement LabelSetPitch 
            {
                get
                {
                    String selectPitchLabelName = "Select Pitch:"; //TODO$: Globalize this resource.
                    return GetElementByName(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Text, selectPitchLabelName);
                }
                //get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Text, "setPitchLabel"); } 
            }
            // ----------------------------------------------------------------
            // Control         : ComboBox
            // Name            : Set Pitch
            ...
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement ComboBoxPitchSetting { get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.ComboBox, "804"); } }  //Win7: pitchSetting
            // ----------------------------------------------------------------
            // Control         : Button
            // Name            : OK
            // Parent          :
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement ButtonOK { get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Button, "1"); } } //Win7: applySettingsButton
            // ----------------------------------------------------------------
            // Control         : Button
            // Name            : Cancel
            // Parent          :
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement ButtonCancel { get { return GetElement(DialogVoiceSettings.AutomationElement, TreeScope.Subtree, ControlType.Button, "2"); } }  //Win7: cancelButton
            // ----------------------------------------------------------------
            // Control         : TitleBar
            // Name            : Voice Settings - Narrator
            ...
            public class TitleBar
            {
                ...
                {
                    public static AutomationElement AutomationElement { get { return GetElement(MainForm.DialogVoiceSettings.TitleBar.AutomationElement, TreeScope.Subtree, ControlType.MenuBar, "SystemMenuBar"); } }  //Win7: VoiceSettingsForm
                    // --------------------------------------------------------
                    // Control         : MenuItem
                    // Name            : System
                    // Parent          : System Menu Bar
        ...
        public class DialogBackgroundMessage
        {
            // ----------------------------------------------------------------
            // Control         : Window
            // Name            : Background Message Settings - Narrator
            // Parent          : Microsoft Narrator
            // Parent Control  : Window
            // ----------------------------------------------------------------
            public static AutomationElement AutomationElement 
            {
                get
                {
                    String backgroundMessageSettingsName = "Background Message Settings - Narrator"; //TODO$: Globalize this resource
                    return GetElementByName(MainForm.AutomationElement, TreeScope.Children, ControlType.Window, backgroundMessageSettingsName);
                }
                //get { return GetElement(MainForm.AutomationElement, TreeScope.Children, ControlType.Window, "MessageSettingsForm"); } 
            }
            // ----------------------------------------------------------------
            // Control         : Button
            // Name            : Cancel
            // Parent          : Background Message Settings - Narrator
            // Parent Control  : Window
            // ----------------------------------------------------------------
            public static AutomationElement Cancel { get { return GetElement(DialogBackgroundMessage.AutomationElement, TreeScope.Subtree, ControlType.Button, "2"); } }  //Win7: cancelButton
            // ----------------------------------------------------------------
            // Control         : Button
            // Name            : OK
            // Parent          : Background Message Settings - Narrator
            // Parent Control  : Pane
            // ----------------------------------------------------------------
            public static AutomationElement OK { get { return GetElement(DialogBackgroundMessage.AutomationElement, TreeScope.Subtree, ControlType.Button, "1"); } } //Win7: applySettingsButton
            // ----------------------------------------------------------------
            // Control         : Combo Box
            // Name            : Please Choose a Time period
            // Parent          : Background Message Settings - Narrator
            // Parent Control  : Window
            // ----------------------------------------------------------------
            public static AutomationElement TimePeriodComboBox { get { return GetElement(DialogBackgroundMessage.AutomationElement, TreeScope.Subtree, ControlType.ComboBox, "810"); } }  //Win7: timePeriodSetting
        }
        ...
        public class AboutDialog
        {
            ...
            public static AutomationElement AutomationElement 
            {
                get
                {
                    String aboutDialogName = "About Narrator";  //TODO$: Globalize this resource.
                    return GetElementByName(MainForm.AutomationElement, TreeScope.Children, ControlType.Window, aboutDialogName);
                }
                //get { return GetElement(MainForm.AutomationElement, TreeScope.Children, ControlType.Window, ""); }
            }
            // ----------------------------------------------------------------
            // Control         : Button
            // Name            :
