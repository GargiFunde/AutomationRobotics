...
namespace Microsoft.Test.UIAutomation.Tests.Patterns
{
	...
	public sealed class TransformTests : TransformPatternWrapper
    {
        ...
        public void CanRotate16(TestCaseAttribute testCase)
        {
            ...
            {
                //"Precondition: TransformPattern.CanRotate == true", 
                TSC_VerifyProperty(pCanRotate, true, true, TransformPattern.CanRotateProperty, CheckType.IncorrectElementConfiguration);
        ...
        public void Move21(TestCaseAttribute testCase)
        {
            ...
            {
                //"Precondition: TransformPattern.CanMove == true", 
                TSC_VerifyProperty(pCanMove, true, true, TransformPattern.CanMoveProperty, CheckType.IncorrectElementConfiguration);
        ...
        [TestCaseAttribute("Move.2.12",
            ...
            TestCaseType = TestCaseType.Events, EventTested = "AutomationPropertyChangedEventHandler(AutomationElement.BoundingRectangleProperty)",
            Priority = TestPriorities.Pri1,
            Status = TestStatus.Problem, // Need to verify that the window is maximizable 1st
            Author = "Microsoft Corp.",
            Description = new string[] {
                "Precondition: Verify that window supports maximizing",
                "Verify: Call WindowPattern.SetWindowVisualState(WindowVisualState.Maximize)", 
        ...
        public void Move212(TestCaseAttribute testCase)
        {
            ...
            TSC_VerifyProperty(m_le.GetCurrentPropertyValue(WindowPattern.CanMaximizeProperty), true, true, WindowPattern.CanMaximizeProperty, CheckType.IncorrectElementConfiguration);
            TS_SetWindowVisualState(m_le, WindowVisualState.Maximized, CheckType.Verification);
            TS_VerifyWindowVisualState(m_le, WindowVisualState.Maximized, CheckType.Verification);
        ...
        [TestCaseAttribute("Move.2.17",
            ...
            Author = "Microsoft Corp.",
            Description = new string[] {
                "Precondition: Verify that window supports minimizing",
                "Step: Obtain a random location on the screen other than current location", 
        ...
        public void Move217(TestCaseAttribute testCase)
        {
            ...
            TSC_VerifyProperty(m_le.GetCurrentPropertyValue(WindowPattern.CanMinimizeProperty), true, true, WindowPattern.CanMinimizeProperty, CheckType.IncorrectElementConfiguration);
        ...
        public void Resize32(TestCaseAttribute testCase)
        {
            ...
            {
                //"Precondition: TransformPattern.CanResize == true", 
                TSC_VerifyProperty(pCanResize, true, true, TransformPattern.CanResizeProperty, CheckType.IncorrectElementConfiguration);
