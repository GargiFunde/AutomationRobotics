...
namespace Microsoft.Test.UIAutomation.Tests.Patterns
{
    ...
    public sealed class SelectionItemTests : SelectionItemPatternWrapper
    {
        ...
        public void TestSelect28(TestCaseAttribute testCase)
        {
            ...
            {
                this.HeaderComment(testCase);
                this.TestDriverAddToSelection1(true, false, typeof(InvalidOperationException)); //typeof(InvalidOperationException));
            }
            catch (Exception e)
            {
                throw e; /* amd64fre does not include this function (1st called in assembly?) in the trace unless we do this */
        ...
        public void TestSelect27(TestCaseAttribute testCase)
        {
            ...
            {
                this.HeaderComment(testCase);
                // Should be false on the 1011 list box.  There may be other scenarios where it is otherwise.  If we find them, bug it.
