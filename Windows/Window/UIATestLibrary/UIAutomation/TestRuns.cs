...
namespace Microsoft.Test.UIAutomation
{
    ...
    public sealed class TestRuns
    {
        ...
        /// UIA Verify should preserve existing content for controls that support
        ...
        static string _bugFilterFile = string.Empty;

        /// -------------------------------------------------------------------
        /// <summary>Bug filter file</summary>
        /// -------------------------------------------------------------------
        public static string BugFilterFile
        {
            get { return TestRuns._bugFilterFile; }
            set { TestRuns._bugFilterFile = value; }
        }

        static bool _isClientSideProviderLoaded = true;

        /// -------------------------------------------------------------------
        /// <summary>Bug filter file</summary>
        /// -------------------------------------------------------------------
        public static bool IsClientSideProviderLoaded
        {
            get
            {
                return _isClientSideProviderLoaded;
            }
        }
        ...
        /// -------------------------------------------------------------------
        /// <summary>String property for the command line that started this test 
        /// run.  No required.</summary>
        /// -------------------------------------------------------------------
        ...
        {
            UIVerifyLogger.LogComment("Calling UiaRegisterProviderCallback(IntPtr.Zero)");
            _isClientSideProviderLoaded = false;
