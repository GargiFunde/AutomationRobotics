// <copyright file=ServerForm company=E2E Robotics>
...
namespace TCP.Server.UI
{
    public partial class ServerForm : Form
    {
        ...
        void server_ClientValidating(EventArguments.ClientValidatingEventArgs args)
        {
            ...
            {
                Receiver r = server.Receivers.First(x => x.Email == args.Request.Email);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            server.SendMessageToClient(str);
        }
    }
}
