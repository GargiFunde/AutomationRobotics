// <copyright file=Client company=E2E BOTS>
    ...
    public class Client
    {
      ...
      //  public event Action<Client, EventArguments.FileUploadProgressEventArguments> FileUploadProgress;
        ...
        public void Login(String email, Action<Client, ValidationResponse> callback)
        {
            ...
            request.Email = email;
            request.Password = "Piyush";            //Piyush
            request.ProcessId = Process.GetCurrentProcess().Id;
            System.IO.File.AppendAllText(@"C:\Piyush\DebugService.txt", "Client.cs => Login Method to Client request.Email" + email + " . request.ProcessId "+ request.ProcessId + "  \n");
        ...
        {
            System.IO.File.AppendAllText(@"C:\Piyush\DebugService.txt", "Client.cs => AddCallback In CallBack Method" + "  \n");
            if (callBack != null)
            {
                ...
                System.IO.File.AppendAllText(@"C:\Piyush\DebugService.txt", "Client.cs => msg.CallbackID : "+ msg.CallbackID + "  \n");
