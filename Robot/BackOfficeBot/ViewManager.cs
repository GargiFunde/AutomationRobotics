...
namespace BackOfficeBot
{
    ...
    {
        private TCP.Client.Client client =null;

        public ViewManager(IDeviceManager deviceManager)
        {
            //File.AppendAllText(@"c:\Piyush\file.txt", "In View MANAGER"+ "\n");
            ...
            _notifyIcon = new System.Windows.Forms.NotifyIcon(_components)
            {
                ...
                Icon = BackOfficeBot.Properties.Resources.NotReadyIcon,
            ...
            //File.AppendAllText(@"c:\Piyush\file.txt", "In View MANAGER client" + "\n");
            _aboutViewModel = new WpfFormLibrary.ViewModel.AboutViewModel();
            _statusViewModel = new WpfFormLibrary.ViewModel.StatusViewModel(client);
