// <copyright file=SnippingTool company=E2E BOTS>
...
namespace Bot.Activity.ActivityLibrary
{
    public partial class SnippingTool : Form
    {
        ...
        public static Bitmap ImageBMP { get; set; }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            int posx = (int)(_rectSelection.X * hScale);
            int posy = (int)(_rectSelection.Y * vScale);
            int width = _rectSelection.Width;
            int hight = _rectSelection.Height;
            Top = posy;
            Left = posx;
            Size sz = _rectSelection.Size;

            CloseForms();
            Image = new Bitmap(width, hight, PixelFormat.Format32bppArgb);

            using (Graphics gr = Graphics.FromImage(Image))
            {


                //  gr.CopyFromScreen(posx,posy , 0, 0, sz);

                gr.DrawImage(ImageBMP,
