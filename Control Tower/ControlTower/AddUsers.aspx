<%@ Page Title="" Language="C#" MasterPageFile="~/ControlTower/MasterPageSkin.master" AutoEventWireup="true" CodeFile="AddUsers.aspx.cs" Inherits="DemoMasterPage2_AddUsers" EnableTheming="true" %>
                    ...
                    <div id="DIVAddUsers" class="card shadow mb-4" runat="server">
                        <div class="card-header py-3">
                            <h2 class="m-0 font-weight-bold poptxt">
                                 <asp:Literal Id = "LitADDUSERS" runat="server" Text="<%$Resources:content,LitADDUSERS%>"></asp:Literal> 
                            </h2>
                        </div>
                        ...
                        <div class="card-body">
                            <div>
                                <div class="panel panel-default colorFont TableHeaderFont">
                                     ...
                                     <div class="form-group">
                                        <asp:Label ID="lblDomainName" class=" font-weight-bold poptxt" runat="server">
                                    ...
                                    <div class="form-group">
                                <asp:Label ID="Label4" runat="server" class=" font-weight-normal poptxt">
                                    <b>
                                 ...
                                 <asp:DropDownList ID="DrpGroupName" runat="server" class="form-control animated--grow-in" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" AppendDataBoundItems="True" AutoPostBack="true" OnSelectedIndexChanged="getRoletypesForGroup">
                                    ...
                                    <div class="form-group">
                                        <asp:Label ID="lblUserName" class=" font-weight-bold poptxt" runat="server">
                                    ...
                                    <div class="form-group">
                                        <asp:Label ID="lblPassWord" class=" font-weight-bold poptxt" runat="server">
                                    ...
                                    <div class="form-group  font-weight-bold poptxt">
                                        <asp:Label ID="lblRoleTypes" runat="server">
                            ...
                            <div class="form-group" align="center">
                                <asp:Button ID="Button1" runat="server" class="btn btn-primary colorSidebar" Text="<%$Resources:content,LitSave%>" OnClick="btnSave" Width="49%" />
                                <asp:Button ID="Button2" runat="server" class="btn btn-danger" Text="<%$Resources:content,LitClear%>" OnClick="BtnCancelUser" Width="49%" />
                            </div>
                                </div>
                            </div>
                        </div>
                                              ...
                                              <div class="modal-content ">
                                                  <div class="modal-header">
                                                      <h5 class="modal-title h5 font-weight-bold text-danger" id="exampleModalLabel1">
                                                           <asp:Literal Id = "LitDeletUser" runat="server" Text="<%$Resources:content,LitDeletUser%>"></asp:Literal></h5>
                                              ...
                                              <div class="modal-content ">
                                                  <div class="modal-header">
                                                      <h5 class="modal-title h5 font-weight-bold text-danger" id="exampleModalLabelDeleteSecondPopUp">
                                                          <asp:Literal Id = "LitDeleteUserPermanently" runat="server" Text="<%$Resources:content,LitDeleteUserPermanently%>"></asp:Literal></h5>
                                                  ...
                                                  <div class="modal-body TableHeaderFont  poptxt" style="text-align: center" runat="server">
                                                      <asp:Literal Id = "LitYouareabouttodeletetheuserpermanentlyDeleteduserwillnotberecovered" runat="server" Text="<%$Resources:content,LitYouareabouttodeletetheuserpermanentlyDeleteduserwillnotberecovered%>"></asp:Literal> <br />
