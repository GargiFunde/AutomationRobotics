<%@ Page Title="" Language="C#" MasterPageFile="~/ControlTower/MasterPageSkin.master" AutoEventWireup="true" CodeFile="Reports.aspx.cs" Inherits="pages_DemoMasterPage2_SanketCharts" %>
                ...
                <asp:UpdatePanel ID="updpnlWeekly" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div class="card shadow mb-4" id="id1">
                            <div class="card-header py-3">
                                <h5 class="m-0 font-weight-bold poptxt" style="font-size:x-large">
                                     <asp:Literal Id = "LitWeeklyStatus" runat="server" Text="<%$Resources:content,LitWeeklyStatus%>"></asp:Literal>
                 ...
                 <asp:UpdatePanel ID="updpnlDaily" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold poptxt" style="font-size:x-large">
                                     <asp:Literal Id = "LitDailyStatus" runat="server" Text="<%$Resources:content,LitDailyStatus%>"></asp:Literal>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold poptxt" style="font-size:x-large">
                            <asp:Literal Id = "LitMonthlyStatus" runat="server" Text="<%$Resources:content,LitMonthlyStatus%>"></asp:Literal> 
