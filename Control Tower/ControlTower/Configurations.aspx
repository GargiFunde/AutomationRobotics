<%@ Page Title="" Language="C#" MasterPageFile="~/ControlTower/MasterPageSkin.master" AutoEventWireup="true" CodeFile="Configurations.aspx.cs" Inherits="DemoMasterPage2_Configurations" %>
                    ...
                    <div class="card-body TableHeaderFont">
                        <div>
                            <div class="form-group">
                                ...
                                <asp:Literal Id = "LitParameterName" runat="server" Text="<%$Resources:content,LitParameterName%>"></asp:Literal>
                        ...
                        <asp:Literal Id = "LitAccessLevel" runat="server" Text="<%$Resources:content,LitAccessLevel%>"></asp:Literal> 
                                    <span class="text-danger">*</span>
                                </asp:Label>
                            ...
                            <div class="form-group">
                                ...
                                <asp:Literal Id = "LitParameterValue" runat="server" Text="<%$Resources:content,LitParameterValue%>"></asp:Literal> 
                                    <span class="text-danger">*</span>
                                </asp:Label>
                            ...
                            <div class="form-group" align="center">
                                ...
                                <asp:Button ID="Button2" runat="server" class="btn btn-danger" Text="<%$Resources:content,LitCancel%>" OnClick="BtnCancelConfiguration" Width="49%" />
...
<asp:UpdatePanel runat="server">
   <ContentTemplate>--%>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h2 class="m-0 font-weight-bold poptxt">
                            <asp:Literal Id = "LitCONFIGURATIONDETAILS" runat="server" Text="<%$Resources:content,LitCONFIGURATIONDETAILS%>"></asp:Literal>
                    ...
                    <div class="modal-content ">
                        <div class="modal-header">
                            <h5 class="modal-title h5 font-weight-bold text-danger" id="exampleModalLabel1">
                                <asp:Literal Id = "LitDeleteConfiguration" runat="server" Text="<%$Resources:content,LitDeleteConfiguration%>"></asp:Literal>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="right">
                                           <asp:Literal Id = "LitcParameterName" runat="server" Text="<%$Resources:content,LitcParameterName%>"></asp:Literal>   
                                        </div>
                                        ...
                                        <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="right">
                                           <asp:Literal Id = "LitcParameterValue" runat="server" Text="<%$Resources:content,LitcParameterValue%>"></asp:Literal>  
                                        </div>
                    ...
                    <div class="modal-content ">
                        <div class="modal-header">
                            <h5 class="modal-title h5 font-weight-bold text-danger" id="exampleModalLabelDeleteSecondPopUp">
                               <asp:Literal Id = "LitDeleteConfigurationPermanently" runat="server" Text="<%$Resources:content,LitDeleteConfigurationPermanently%>"></asp:Literal>
                        ...
                        <div class="modal-body TableHeaderFont  poptxt" style="text-align: center" runat="server">
                          <asp:Literal Id = "LitYouareabouttodeletetheconfigurationpermanentlyDeletedconfigurationwillnotberecovered" runat="server" Text="<%$Resources:content,LitYouareabouttodeletetheconfigurationpermanentlyDeletedconfigurationwillnotberecovered%>"></asp:Literal>  
                            <br />
                            ...
                            <div class="form-group">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="right">
                                            <asp:Literal Id = "Literal1" runat="server" Text="<%$Resources:content,LitcParameterName%>"></asp:Literal>   
                                        </div>
                                        <div class="col-sm-2 col-2 col-md-2 col-lg-2 col-xl-2" align="left">
                                        ...
                                        <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="right">
                                             <asp:Literal Id = "Literal2" runat="server" Text="<%$Resources:content,LitcParameterValue%>"></asp:Literal>  
                                        </div>
                                        <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3">
                                        <asp:Button ID="Button1" runat="server" class="btn btn-danger btn-block" Text="<%$Resources:content,LitDelete%>" OnClick="ModalPopUpBtnDelete_ClickSecondPopUp" />
                                    </div>
                                    <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3 ">
