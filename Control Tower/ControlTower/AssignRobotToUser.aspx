    <%@ Page Title="" Language="C#" MasterPageFile="~/ControlTower/MasterPageSkin.master" AutoEventWireup="true" CodeFile="AssignRobotToUser.aspx.cs" Inherits="DemoMasterPage2_AssignRobotToUser" %>
...
<asp:ScriptManager runat="server">
                ...
                <div class="panel panel-default colorFont">
                            <div class="card-body TableHeaderFont">
                                <div class="form-group">
                                    <asp:Label ID="Label4" runat="server"  class=" font-weight-bold poptxt">
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label5" runat="server"  class=" font-weight-bold poptxt">
                                ...
                                <div class="form-group" align="center">
                                    <asp:Button ID="btnSave" runat="server" class="btn btn-primary " Text="<%$Resources:content,LitSave%>" OnClick="Save_Click" Width="49%" />
                                    <asp:Button ID="btnCancel" runat="server" class="btn btn-danger" Text="<%$Resources:content,LitCancel%>" OnClick="BtnCancelUser" Width="49%" />
                                </div>
   ...
   <br />
     ...
     <asp:UpdatePanel runat="server">
            ...
            <div class="card-header py-3">
                <h2 class="m-0 font-weight-bold poptxt">
                    <asp:Literal Id = "LitUSERS" runat="server" Text="<%$Resources:content,LitUSERS%>"></asp:Literal>
                                            ...
                                            <thead class="colorSidebar" align="center">
                                                <tr class="poptxt TableHeaderFont">
                                                    <th scope="col" class=" font-weight-bold ">
                                                         <asp:Literal Id = "LitUserId" runat="server" Text="<%$Resources:content,LitUserId%>"></asp:Literal>
                                                    </th>
                                                    <th scope="col" class=" font-weight-bold ">
                                                        <asp:Literal Id = "LitBotName" runat="server" Text="<%$Resources:content,LitBotName%>"></asp:Literal>
                                                    </th>
                                    ...
                                    <div class="modal-content ">
                                        <div class="modal-header">
                                            <h5 class="modal-title h5 font-weight-bold text-danger" id="exampleModalLabel1">
                                               <asp:Literal Id = "LitDeleteRobotToUser" runat="server" Text="<%$Resources:content,LitDeleteRobotToUser%>"></asp:Literal> 
                                        ...
                                        <div class="modal-body TableHeaderFont  poptxt" style="text-align: center" runat="server">
                                            ...
                                            <span class=" font-weight-bold text-danger">
                                                <asp:Literal Id = "LitDelete" runat="server" Text="<%$Resources:content,LitDelete%>"></asp:Literal>  </span>
                                                ...
                                                <div class="container">
                                                      <div class="row">
                                                        <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="right">
                                                          <asp:Literal Id = "LitUserName2" runat="server" Text="<%$Resources:content,LitUserName%>"></asp:Literal> 
                                                        </div>
                                                        <div class="col-sm-2 col-2 col-md-2 col-lg-2 col-xl-2" align="left" >
                                                         <asp:Label ID="lblUserName" Class="font-weight-bold text-danger"  runat="server"> </asp:Label>
                                                          ...
                                                          <div class="col-sm-1 col-1 col-md-1 col-lg-1 col-xl-1">
                                                           ...
                                                           <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="right">
                                                          <asp:Literal Id = "LitBotName1" runat="server" Text="<%$Resources:content,LitBotName%>"></asp:Literal> 
                                                        </div>
                            ...
                            <div class="modal fade " id="modalDeleteSecondPopUp" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelDeleteSecondPopUp" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document" >
                                    <div class="modal-content ">
                                        ...
                                        <div class="modal-body TableHeaderFont  poptxt" style="text-align: center" runat="server">
                                         <asp:Literal Id = "LitYouareabouttodeletetherobottouserpermanentlyDeletedrobottouserwillnotberecovered" runat="server" Text="<%$Resources:content,LitYouareabouttodeletetherobottouserpermanentlyDeletedrobottouserwillnotberecovered%>"></asp:Literal>
                                            <br />
                                        <asp:Literal Id = "LitAreyousureyouwantto1" runat="server" Text="<%$Resources:content,LitAreyousureyouwantto%>"></asp:Literal> 
                                            <span class=" font-weight-bold text-danger">
                                                <asp:Literal Id = "LitDelete1" runat="server" Text="<%$Resources:content,LitDelete%>"></asp:Literal></span>
                                         ...
                                         <br /><br />
                                            <div class="form-group">
                                                <div class="container">
                                                      <div class="row">
                                                        <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="right">
                                                          <asp:Literal Id = "LitUserName1" runat="server" Text="<%$Resources:content,LitUserName%>"></asp:Literal> 
                                                        </div>
                                                        <div class="col-sm-2 col-2 col-md-2 col-lg-2 col-xl-2" align="left" >
                                                         <asp:Label ID="lblUserNameSecondPopUp" Class="font-weight-bold text-danger"  runat="server"> </asp:Label>
                                                          ...
                                                          <div class="col-sm-1 col-1 col-md-1 col-lg-1 col-xl-1">
                                                           ...
                                                           <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="right">
                                                          <asp:Literal Id = "LitBotName2" runat="server" Text="<%$Resources:content,LitBotName%>"></asp:Literal> 
                                                        </div>
                                                          <div class="col-sm-3 col-3 col-md-3 col-lg-3 col-xl-3" align="left">
