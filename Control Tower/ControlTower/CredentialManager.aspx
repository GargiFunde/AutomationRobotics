<%@ Page Title="" Language="C#" MasterPageFile="~/ControlTower/MasterPageSkin.master" AutoEventWireup="true" CodeFile="CredentialManager.aspx.cs" Inherits="ControlTower_AssetManagement1" %>
                    ...
                    <div id="DIVAddUsers" class="card shadow"  runat="server">
                        <div class="card-header py-3">
                            <h2 class="m-0 font-weight-bold poptxt">
                                 <asp:Literal Id = "LitADDCREDENTIAL" runat="server" Text="<%$Resources:content,LitADDCREDENTIAL%>"></asp:Literal>  
                            </h2>
                        </div>
                                ...
                                <div class="panel panel-default colorFont TableHeaderFont">
                                     ...
                                     <div class="form-group">
                                        <asp:Label ID="lblAssetName" class=" font-weight-bold poptxt" runat="server">
                                            <asp:Literal Id = "LitCredentialName" runat="server" Text="<%$Resources:content,LitCredentialName%>"></asp:Literal>  
                                            <span class="text-danger">*</span></asp:Label>
                                        <asp:TextBox ID="txtCredentialName" class="form-control input-sm" runat="server" placeholder="<%$Resources:content,LitCredentialName%>"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <asp:Label ID="lblUserName" class=" font-weight-bold poptxt" runat="server">
                                           <asp:Literal Id = "LitUserName" runat="server" Text="<%$Resources:content,LitUserName%>"></asp:Literal>  
                                            <span class="text-danger">*</span></asp:Label>
                                        <asp:TextBox ID="txtUser" class="form-control input-sm" runat="server"  placeholder="<%$Resources:content,LitUserName%>"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <asp:Label ID="lblPassWord" class=" font-weight-bold poptxt" runat="server">
                                           <asp:Literal Id = "LitPassword" runat="server" Text="<%$Resources:content,LitPassword%>"></asp:Literal>
                                            <span class="text-danger">*</span></asp:Label>
                                        <asp:TextBox ID="txtPassWord" class="form-control input-sm"  type="password" runat="server" placeholder="<%$Resources:content,LitPassword%>"></asp:TextBox>
             ...
             <asp:UpdatePanel runat="server">
                  <ContentTemplate>
                      <div class="card shadow mb-4">
                          <div class="card-header py-3">
                              <h2 class="m-0 font-weight-bold poptxt">
                                  <asp:Literal Id = "LitCREDENTIALS" runat="server" Text="<%$Resources:content,LitCREDENTIALS%>"></asp:Literal>
                                              ...
                                              <div class="modal-content ">
                                                  <div class="modal-header">
                                                      <h5 class="modal-title h5 font-weight-bold text-danger" id="exampleModalLabel1">
                                                         <asp:Literal Id = "LitDeleteCredential" runat="server" Text="<%$Resources:content,LitDeleteCredential%>"></asp:Literal>  
