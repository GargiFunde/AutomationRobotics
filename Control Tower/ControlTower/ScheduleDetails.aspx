<%@ Page Title="" Language="C#" MasterPageFile="~/ControlTower/MasterPageSkin.master" AutoEventWireup="true" CodeFile="ScheduleDetails.aspx.cs" Inherits="DemoMasterPage2_ScheduleDetails" %>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h2 class="m-0 font-weight-bold poptxt">
                     <asp:Literal Id="LitScheduleDetailsLogs" runat="server" Text="<%$Resources:content,LitScheduleDetailsLogs%>"></asp:Literal>   
                ...
                <div class="table">
                    ...
                    <div class="panel-body colorFont">
                                ...
                                <div class="row" align="center">
                                    <div class="col-sm-12">
                                        <asp:Button ID="btnPrevious" runat="server" CssClass="btn btn-dark buttoncss" Text="<%$Resources:content,LitPreviouslyExecutedProcesses%>"  OnClick="btnPrevious_Click"  />&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnProcessing" runat="server" CssClass="btn btn-success buttoncss" Text="<%$Resources:content,LitCurrentlyExecutingProcesses%>"  OnClick="btnProcessing_Click" />&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="btnFailed" runat="server" CssClass="btn btn-dark buttoncss" Text="<%$Resources:content,LitFailedExecutingProcesses%>"  Onclick="btnFailed_Click" />&nbsp;&nbsp;&nbsp;</br><br />
                                    <asp:Button ID="btnScheduled" runat="server" CssClass="btn btn-dark buttoncss" Text="<%$Resources:content,LitScheduledExecutableProcesses%>"  OnClick="btnScheduled_Click"  />
                                         <br /><br />
                                    </div>
                                </div>
                                <div class="row" align="center">
                                    ...
                                    <asp:Repeater ID="GrvSchedules" runat="server">
                                            ...
                                            <table class=" table-striped table-bordered table-hover dataTable no-footer dtr-inline tablecolor" id="dataTables-schedules" width="100%">
                                                <thead class="mastercolor colorSidebar" align="center">
                                                    <tr class="TableHeaderFont">
                                                        ...
                                                        <th scope="col" class=" font-weight-bold poptxt">
                                                            <asp:Literal Id="LitsdQueueName" runat="server" Text="<%$Resources:content,LitsdQueueName%>"></asp:Literal>  
                                                        </th>
                                                        <th scope="col" class=" font-weight-bold poptxt">
                                                           <asp:Literal Id="LitsdCronExpression" runat="server" Text="<%$Resources:content,LitsdCronExpression%>"></asp:Literal> 
                                                        </th>
                                                        <th scope="col" class=" font-weight-bold poptxt">
                                                            <asp:Literal Id="LitStatus" runat="server" Text="<%$Resources:content,LitStatus%>"></asp:Literal> 
                                                        </th>
                                                        <th scope="col" class="h5 font-weight-bold poptxt">
                                                            <asp:Literal Id="LitLogs" runat="server" Text="<%$Resources:content,LitLogs%>"></asp:Literal>  
                                                        </th>
                                                    </tr>
                                                </thead>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr style="padding: 0px; margin: 0px; border: .25px solid #E5E5E5;" id="mainData " class="repeaterrow poptxtdata ">
                                                ...
                                                <td style="text-align: center; align-content: center; align-items: center;"><%--+ ","+Eval("StartTime")+ ","+Eval("EndTime")--%>
                                                    <asp:ImageButton ID="ImageButton5" runat="server" CssClass="info" ImageUrl="~/Images/info3.png" ImageAlign="Middle" CommandArgument='<%#Eval("botname") + ","+Eval("machinename") %>' OnCommand="LoadBotLogs" /> 
                                                 </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
                ...
                <div class="modal-dialog modal-xl" role="document" >
                    <div class="modal-content ">
                        <div class="modal-header">
                            <h5 class="modal-title h4 font-weight-bold text-primary" id="exampleModalLabel">
                            ...
                            <asp:Repeater ID="Repeater2" runat="server">
                                <HeaderTemplate>
                                    <table class="table table-striped table-bordered table-hover"  id="dataTables-BotDashboard">
                                        <thead class="mastercolor colorSidebar" align="center">
                                            <tr>
                                                <th scope="col" class="h5 font-weight-bold text-primary">
                                                ...
                                                <th scope="col" class="h5 font-weight-bold text-primary">
                                                  <asp:Literal Id="LitTimeStamp" runat="server" Text="<%$Resources:content,LitTimeStamp%>"></asp:Literal>  

                                                </th>
                                                <th scope="col" class="h5 font-weight-bold text-primary">
                                                    <asp:Literal Id="LitLogLevel" runat="server" Text="<%$Resources:content,LitLogLevel%>"></asp:Literal>
                                                </th>
                                                <th scope="col" class="h5 font-weight-bold text-primary">
                                                    <asp:Literal Id="LitMessageValue" runat="server" Text="<%$Resources:content,LitMessageValue%>"></asp:Literal>
                                                </th>
                                            </tr>
                                        </thead>
                                </HeaderTemplate>
                        ...
                        <div class="modal-footer">
                            <button id="ClosePop2" class="btn btn-danger" type="button" data-dismiss="modal">
                                 <asp:Literal Id="LitCancel" runat="server" Text="<%$Resources:content,LitCancel%>"></asp:Literal>
