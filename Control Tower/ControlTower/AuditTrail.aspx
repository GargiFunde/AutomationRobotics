<%@ Page Title="" Language="C#" MasterPageFile="~/ControlTower/MasterPageSkin.master" AutoEventWireup="true" CodeFile="AuditTrail.aspx.cs" Inherits="AuditTrail" %>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="dataTables-logs" width="100%">
                                                            <thead class="colorSidebar" align="center">
                                                                <tr class="poptxt TableHeaderFont">
                                                                    ...
                                                                    <th scope="col" class=" font-weight-bold ">
                                                                        <asp:Literal Id = "LitDetails" runat="server" Text="<%$Resources:content,LitDetails%>"></asp:Literal> 
                                                                    </th>
