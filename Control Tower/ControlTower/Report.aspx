<%@ Page Title="" Language="C#" MasterPageFile="~/ControlTower/MasterPageskin.master" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="pages_DemoMasterPage2_SanketCharts" %>
    ...
    <div class="container-fluid" style="font-family:Helvetica">
                ...
                <asp:UpdatePanel ID="updpnlWeekly" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div class="card shadow mb-4" id="id1">
                            <div class="card-header py-3">
                                <h5 class="m-0 font-weight-bold text-primary" style="font-size:x-large">Weekly Status</h5>
                               <br>
                                <div class="row">
                 ...
                 <asp:UpdatePanel ID="updpnlDaily" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary" style="font-size:x-large">Daily Status</h6>
                                <br>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary" style="font-size:x-large">Monthly Status</h6>
