...
namespace Bot.Activity.UserInputs
{
    ...
    /// </summary>
    public partial class UserIdPassword : Window
    {
        public UserInputEntity userInput { get; set; }
        public UserIdPassword(ref UserInputEntity userInputentity)
        {
            InitializeComponent();
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if ((txtuserInput.Text.Trim().Length == 0)||(txtPassword.Password.Trim().Length == 0))
                {
