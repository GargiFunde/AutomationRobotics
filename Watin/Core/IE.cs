...
namespace WatiN.Core
{
	...
	/// </code>
	/// </example>
	public class IE : Browser, CommonLibrary.Interfaces.IApplicationInterface
    {
	    ...
	    private void CreateNewIEAndGoToUri(Uri uri, IDialogHandler logonDialogHandler, bool createInNewProcess)
		{
			...
			else
			{
				...
				SHDocVw.InternetExplorer internetExplorer = new InternetExplorer();
				//internetExplorerClass.OnQuit += InternetExplorerClass_OnQuit;
                _ieBrowser = CreateIEBrowser(internetExplorer);
   ...
   //         var isSTA = (Thread.CurrentThread.GetApartmentState() == ApartmentState.STA);
		...
		public override void Close()
		{
            ...
            //Use processid to kill the process...it do not work in dynamic dom scenario
		}
        ...
        //private void InternetExplorerClass_OnQuit()
        //{
        //    IECreatedEventArgs iECreatedEventArgs = new IECreatedEventArgs(null);
        ...
        //    SelectHelper.OnIECreated(iECreatedEventArgs);
        //    //_ieBrowser.hWnd
        //    //_ieBrowser = IE.AttachTo<IE>(new AttributeConstraint("hwnd", _ieBrowser.hWnd.ToString()))._ieBrowser; 
