...
namespace WatiN.Core
{
    ...
    /// </code>
    /// </example>
    public class IE : DomContainer, CommonLibrary.Interfaces.IApplicationInterface
    {
     ...
     //   public Task taskA = null;
        ...
        SHDocVw.InternetExplorer ieclass = null;
        private void CreateNewIEAndGoToUri(Uri uri, LogonDialogHandler logonDialogHandler, bool createInNewProcess)
        {
            ...
            {
                Logger.Log.Logger.LogData("Creating IE instance in a new process", Logger.LogLevel.Debug);
                InitIEAndStartDialogWatcher(CreateIEInNewProcess(), uri);
                ieclass.OnQuit += Ieclass_OnQuit;
            }
            else
            {
                Logger.Log.Logger.LogData("Creating IE instance", Logger.LogLevel.Debug);
                ieclass = new SHDocVw.InternetExplorer();
                               
                ieclass.AddressBar = true;
                ieclass.OnQuit += Ieclass_OnQuit;
                InitIEAndStartDialogWatcher(ieclass, uri);
            }
        ...
        public void OnApplicationClose(object sender, AutomationEventArgs e)
        {
            IECreatedEventArgs iECreatedEventArgs = new IECreatedEventArgs(null);
            iECreatedEventArgs.Type = 1;//stop
            iECreatedEventArgs.ApplicationId = ApplicationId;
            // iECreatedEventArgs.searchUrl = SearchUrl;
            SelectHelper.OnIECreated(iECreatedEventArgs);
        }

        public void Ieclass_OnQuit()
        {
            IECreatedEventArgs iECreatedEventArgs = new IECreatedEventArgs(null);
            iECreatedEventArgs.Type = 2;//Reattach Handler
            iECreatedEventArgs.ApplicationId = ApplicationId;
            // iECreatedEventArgs.searchUrl = SearchUrl;
            SelectHelper.OnIECreated(iECreatedEventArgs);
        }
            ...
            do
            {
                ...
                }catch(Exception ex)
                {
                    try
                    {
                        ...
                        {
                            if ((!String.IsNullOrEmpty(process.MainWindowTitle)) && (process.MainWindowTitle.Contains("Blank Page")))
                            {
       ...
       // int iIECreated = 0;
        ...
        {
            ie = internetExplorer;
            ieclass = internetExplorer;
            //IECreatedEventArgs iECreatedEventArgs = new IECreatedEventArgs(ieclass);
            //SelectHelper.OnIECreated(iECreatedEventArgs);
            ...
            //        try
            //        {
            //            ieclass.DocumentComplete -= Ie_DocumentComplete;
            //        }
            //        catch (Exception ex)
            //        {
        ...
        {
            Logger.Log.Logger.LogData("Busy finding Internet Explorer matching constriant " + findBy.ConstraintToString(), Logger.LogLevel.Debug);
        ...
        public void GoTo(Uri url)
        {
            ...
            {
                Logger.Log.Logger.LogData("Operation timed out", Logger.LogLevel.Error);
            }
        }
        ...
        private void navigateTo(Uri url)
        {
            try
            {
                Logger.Log.Logger.LogData("Navigating to '" + url.AbsoluteUri + "'", Logger.LogLevel.Debug);
		...
		public bool Back()
        {
            try
            {
                ie.GoBack();
                WaitForComplete();
                Logger.Log.Logger.LogData("Navigated Back to '" + Url + "'", Logger.LogLevel.Debug);
                return true;
            }
            catch (COMException)
            {
                Logger.Log.Logger.LogData("No history available, didn't navigate Back.", Logger.LogLevel.Debug);
                return false;
            }
        }
        ...
        public bool Forward()
        {
            try
            {
                ie.GoForward();
                WaitForComplete();
                Logger.Log.Logger.LogData("Navigated Forward to '" + Url + "'", Logger.LogLevel.Debug);
                return true;
            }
            catch (COMException)
            {
                Logger.Log.Logger.LogData("No forward history available, didn't navigate Forward.", Logger.LogLevel.Debug);
                return false;
            }
        }
        ...
        public void Refresh()
        {
            Logger.Log.Logger.LogData("Refreshing browser from '" + Url + "'", Logger.LogLevel.Debug);
        ...
        public void Close()
        {
            if (!isDisposed)
            {
                ...
                {
                    Logger.Log.Logger.LogData("Closing browser '" + Title + "'", Logger.LogLevel.Debug);
                }
        ...
        public virtual void ForceClose()
        {
            ...
            Logger.Log.Logger.LogData("Force closing all IE instances", Logger.LogLevel.Debug);
        ...
        {
            Logger.Log.Logger.LogData("Clearing cookies for all sites.", Logger.LogLevel.Debug);
        ...
        public void ClearCookies(string url)
        {
            ...
            Logger.Log.Logger.LogData(String.Format("Clearing cookies for site '{0}'.", url), Logger.LogLevel.Debug);
        ...
        {
            Logger.Log.Logger.LogData("Clearing browser cache.",Logger.LogLevel.Info);
        ...
        {
            Logger.Log.Logger.LogData("Busy finding HTMLDialog matching criteria: " + findBy.ConstraintToString(), Logger.LogLevel.Debug);
