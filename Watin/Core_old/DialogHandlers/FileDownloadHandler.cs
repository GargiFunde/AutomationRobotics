	...
	public class FileDownloadHandler : BaseDialogHandler
	{
		...
		public override bool HandleDialog(Window window)
		{
			...
			if (!HasHandledFileDownloadDialog && IsFileDownloadDialog(window))
			{
				...
				{
					Logger.Log.Logger.LogData("Download started at " + DateTime.Now.ToLongTimeString(), Logger.LogLevel.Debug);
                    Logger.Log.Logger.LogData("Clicked " + _optionEnum.ToString(), Logger.LogLevel.Debug);
                }
			...
			{
				Logger.Log.Logger.LogData("Saving Download file as " + saveAsFilename, Logger.LogLevel.Debug);
...
//      Logger.Log.Logger.LogData("Exists: exists == " + exists.ToString());
//
//	    bool visible = dialog.Visible;
//      Logger.Log.Logger.LogData("Exists: visible == " + visible.ToString());
//      
//      return exists && visible;
		...
		public bool ExistsOrNull(Window dialog)
		{
			if (dialog == null)
			{
//	      Logger.Log.Logger.LogData("ExistsOrNull: dialog == null");
				return true;
			}
		...
		public void WaitUntilFileDownloadDialogIsHandled(int waitDurationInSeconds)
		{
			...
			{
//        Logger.Log.Logger.LogData("WaitUntilFileDownloadDialogIsHandled");
				Thread.Sleep(200);
			}
		...
		public void WaitUntilDownloadCompleted(int waitDurationInSeconds)
		{
			...
			{
//        Logger.Log.Logger.LogData("WaitUntilDownloadCompleted");
				Thread.Sleep(200);
			}
			...
			Logger.Log.Logger.LogData("Download complete at " + DateTime.Now.ToLongTimeString(), Logger.LogLevel.Debug);
        }
