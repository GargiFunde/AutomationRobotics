...
namespace WatiN.Core
{
	...
	public class Element : IAttributeBag
	{
		...
		public void Click()
		{
			...
			Logger.Log.Logger.LogData("Clicking " + GetType().Name + " '" + ToString() + "'", Logger.LogLevel.Debug);
            Highlight(true);
		...
		public void ClickNoWait()
		{
			...
			Logger.Log.Logger.LogData("Clicking (no wait) " + GetType().Name + " '" + ToString() + "'", Logger.LogLevel.Debug);
		...
		public void DoubleClick()
		{
			...
			Logger.Log.Logger.LogData("Double clicking " + GetType().Name + " '" + ToString() + "'", Logger.LogLevel.Debug);
