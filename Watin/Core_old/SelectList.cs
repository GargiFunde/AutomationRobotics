...
namespace WatiN.Core
{
...
#endif
	{
		...
		{
			Logger.Log.Logger.LogData("Clearing selection(s) in " + GetType().Name + " '" + Id + "'", Logger.LogLevel.Debug);
		...
		{
			Logger.Log.Logger.LogData("Selecting '" + text + "' in " + GetType().Name + " '" + Id + "'", Logger.LogLevel.Debug);
		...
		{
			Logger.Log.Logger.LogData("Selecting text using regular expresson '" + regex.ToString() + "' in " + GetType().Name + " '" + Id + "'", Logger.LogLevel.Debug);
		...
		{
			Logger.Log.Logger.LogData("Selecting item with value '" + value + "' in " + GetType().Name + " '" + Id + "'", Logger.LogLevel.Debug);
