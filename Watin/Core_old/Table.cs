...
namespace WatiN.Core
{
...
#endif
	{
		...
		{
			Logger.Log.Logger.LogData("Searching for '" + findText + "' in column " + inColumn + " of " + GetType().Name + " '" + Id + "'", Logger.LogLevel.Debug);
		...
		{
			Logger.Log.Logger.LogData("Matching regular expression'" + findTextRegex + "' with text in column " + inColumn + " of " + GetType().Name + " '" + Id + "'", Logger.LogLevel.Debug);
		...
		{
			Logger.Log.Logger.LogData("Matching comparer'" + comparer + "' with text in column " + inColumn + " of " + GetType().Name + " '" + Id + "'", Logger.LogLevel.Debug);
