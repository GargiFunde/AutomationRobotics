...
namespace WatiN.Core
{
...
#endif
	{
		...
		{
			Logger.Log.Logger.LogData("Typing '" + value + "' into " + GetType().Name + " '" + ToString() + "'",Logger.LogLevel.Info);
		...
		{
			Logger.Log.Logger.LogData("Appending '" + value + "' to " + GetType().Name + " '" + ToString() + "'", Logger.LogLevel.Debug);
		...
		public void Clear()
		{
			Logger.Log.Logger.LogData("Clearing " + GetType().Name + " '" + ToString() + "'", Logger.LogLevel.Debug);
		...
		public string Value
		{
			...
			set
			{
				Logger.Log.Logger.LogData("Setting " + GetType().Name + " '" + ToString() + "' to '" + value + "'", Logger.LogLevel.Debug);
